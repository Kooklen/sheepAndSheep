<template>
  <div id="gamePage">
    <a-row align="space-between">
      ...
      <a-button @click="bgPlay">背景音乐</a-button>
    ...
    <div class="skill-board">
      <a-space>
        ...
        <audio controls hidden src="../../public/click.mp3" id="clickAudio"></audio>
    <audio controls src="../../public/bg.mp3" id="bgMusic" ref="bgAudio" hidden></audio>
